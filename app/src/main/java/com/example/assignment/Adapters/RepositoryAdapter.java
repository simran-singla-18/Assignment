...
public class RepositoryAdapter extends RecyclerView.Adapter<RepositoryAdapter.ReposViewHolder>  {
    ...
    public RepositoryAdapter(ArrayList<GitHubRepo> repos, int rowLayout, Context context) {
        this.setRepos(repos);
        this.setRowLayout(rowLayout);
        this.setContext(context);
    }

    public ArrayList<GitHubRepo> getRepos() {return repos;}

    public void setRepos(ArrayList<GitHubRepo> repos) {this.repos = repos;}
    ...
    @Override
    public RepositoryAdapter.ReposViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
