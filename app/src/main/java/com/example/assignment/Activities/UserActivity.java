...
import com.example.assignment.Endpoints.GitHubUserEndPoints;
    ...
    public void loadData() {
        ...
        call.enqueue(new Callback<GitHubUser>() {
            ...
            public void onResponse(Call<GitHubUser> call, Response<GitHubUser>
                ...
                followersTV.setText( response.body().getFollowers()+" followers");
                followingTV.setText(response.body().getFollowing()+" following");
